...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BaseSource.Model.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "598de92d-7093-440c-a0ee-8bb12c081632",
                            CreatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1452),
                            CreatedBy = "admin",
                            Enable = true,
                            Name = "Customer",
                            UpdatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1453),
                            UpdatedBy = "admin"
                        },
                        new
                        {
                            Id = "8353714b-f269-4c91-8ef0-9f6676d3e72f",
                            CreatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1456),
                            CreatedBy = "admin",
                            Enable = true,
                            Name = "Staff",
                            UpdatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1456),
                            UpdatedBy = "admin"
                        },
                        new
                        {
                            Id = "8989fa46-b9df-4859-92da-7c5006a975c0",
                            CreatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1459),
                            CreatedBy = "admin",
                            Enable = true,
                            Name = "Collaborator",
                            UpdatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1459),
                            UpdatedBy = "admin"
                        },
                        new
                        {
                            Id = "a54f6ccc-7c4b-4adc-91d2-e027dbf3ea6f",
                            CreatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1461),
                            CreatedBy = "admin",
                            Enable = true,
                            Name = "Manager",
                            UpdatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1462),
                            UpdatedBy = "admin"
                        },
                        new
                        {
                            Id = "84bf9034-901b-41f1-ba6c-65f77544513f",
                            CreatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1464),
                            CreatedBy = "admin",
                            Enable = true,
                            Name = "Admin",
                            UpdatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1464),
                            UpdatedBy = "admin"
                        },
                        new
                        {
                            Id = "129e5e62-c185-4f41-a154-dece9191e15f",
                            CreatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1466),
                            CreatedBy = "admin",
                            Enable = true,
                            Name = "Super Admin",
                            UpdatedAt = new DateTime(2023, 10, 8, 15, 9, 22, 589, DateTimeKind.Utc).AddTicks(1467),
                            UpdatedBy = "admin"
                        });
                });
            ...
            modelBuilder.Entity("BaseSource.Model.Admin", b =>
                {
                    b.HasOne("BaseSource.Model.Address", "Address")
                        .WithMany()
